...
import {
  ...
  UptimeColumn,
  BlockProposalColumn,
  BlockImportAndVerificationColumn,
  BlockImportDataRootAndExtensionColumn,
} from './';
...
export type Column =
  ...
  | typeof UptimeColumn
  | typeof BlockProposalColumn
  | typeof BlockImportAndVerificationColumn
  | typeof BlockImportDataRootAndExtensionColumn;
