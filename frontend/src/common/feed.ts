...
export const ACTIONS = {
  ...
  ImportedBlockMetrics: 0x17 as const,
};
...
interface ImportedBlockMetricsMessage extends MessageBase {
  action: typeof ACTIONS.ImportedBlockMetrics;
  payload: [NodeId, BlockMetricDetails];
}
